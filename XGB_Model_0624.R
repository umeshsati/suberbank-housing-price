...
xgbmodel1 <- xgb.train(params = param, data=train_set,nround=187, nfold = 5)
...
write.csv(cbind(id,price_doc), "D:/Data Science/Kaggle/Russian house prize/pred/prediction_0628_6.csv",row.names = F)
